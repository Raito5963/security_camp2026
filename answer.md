...
しかしながら、その友人とは別の学校に進学してしまい対面で開発を一緒に行うことができなくなりました。また友人は大学生活が始まり多忙になると思われるので今までのようにバックエンドやってとお願いするのも難しくなると思いました。
...
しかし今までの友人の開発を見てみるとSupabaseだけではなく、RedisやMINIO、GINなど様々なツールを使用していました。

セキュリティ面やパフォーマンス、通信コストなど様々な面を考慮して開発を行っている友人がかっこよかったので今回の進学を機に自分もバックエンドについて学び、フルスタックエンジニアを目指そうと思いました。
